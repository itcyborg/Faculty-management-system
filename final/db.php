...
$CREATE=["CREATE TABLE `departments`(`id` INT AUTO_INCREMENT PRIMARY KEY,`name` VARCHAR(100) NOT NULL UNIQUE KEY,`head` VARCHAR(60)NOT NULL UNIQUE KEY,`time` TIMESTAMP)",
	...
	"CREATE TABLE `students`(`adm_number` VARCHAR(15) NOT NULL PRIMARY KEY,`name` VARCHAR(30) NOT NULL,`year` VARCHAR(6) NOT NULL,`course` VARCHAR(100) NOT NULL,`contact` INT,`email` VARCHAR(60) NOT NULL,`password` VARCHAR(20) NOT NULL
	)",
